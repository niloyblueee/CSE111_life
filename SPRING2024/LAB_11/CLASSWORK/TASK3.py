...
class SavingsAccount (Account):
    def __init__(self,acc_type,num,balance,interest,minimum):
        super().__init__(num,balance)
        self.account_type,self.inter_rate,self.minimum=acc_type,interest,minimum
...
class FixedDepositAccount(Account):
    def __init__(self,acc_type,num,balance,age):
        super().__init__(num,balance)
        self.age,self.account_type=age,acc_type
    def deposit(self, amount):
